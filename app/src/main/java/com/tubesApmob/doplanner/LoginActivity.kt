...
class LoginActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.inputEmailLogin.setOnClickListener {
            binding.tiLoginEmail.error = null
        }
        binding.inputPasswordLogin.setOnClickListener {
            binding.tiLoginPassword.error = null
        }
        ...
        binding.btLoginLogin.setOnClickListener {
            ...
            if (email.isEmpty()) {
                binding.tiLoginEmail.error = "Email tidak boleh kosong"
                return@setOnClickListener
            }
            if (password.isEmpty()) {
                binding.tiLoginPassword.error = "Password tidak boleh kosong"
                return@setOnClickListener
            }
            ...
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    ...
                    if (user!!.isEmailVerified) {
                        ...
                        Snackbar.make(
                            layoutLogin, "Email belum diverifikasi",
                            Snackbar.LENGTH_INDEFINITE
                        ).setAction("Kirim Email") {
                    ...
                    Snackbar.make(
                        layoutLogin, "Login gagal: " + task.exception!!.localizedMessage,
